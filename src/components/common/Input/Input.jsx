    ...
    return (
        <div className="w-full relative group">
            ...
            <input
                ...
                type={type}
                className={`w-full duration-200 group-focus-within:bg-red-50 border-[1.5px] group-focus-within:border-[#E21221] rounded-lg pl-6 py-4 bg-gray-100 outline-none
